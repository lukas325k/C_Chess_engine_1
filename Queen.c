...
int8_t* QueenGetValidMoves(int8_t *Board, int8_t Index, int8_t SelectedPiece)
{
    static int8_t ValidMoves[29];
    static int8_t directions[] = {1, 8, -1, -8, 7, 9, -7, -9};
...
void MQueenGetValidMoves(int8_t *Board, int8_t Index, int8_t SelectedPiece, int8_t *ValidMovesBuffer)
{
    static int8_t directions[] = {1, 8, -1, -8, 7, 9, -7, -9};
    int SpaceLeft = Index%8 + 1;
    int SpaceRight = 8 - Index%8;
...
void QueenGetCaptures(int8_t *Board, int8_t Index, int8_t SelectedPiece, int8_t *CapturesBuffer)
{
    static int8_t directions[] = {1, 8, -1, -8, 7, 9, -7, -9};
    int SpaceLeft = Index%8 + 1;
    int SpaceRight = 8 - Index%8;
